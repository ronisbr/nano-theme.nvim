...
local ok, failure = xpcall(function()
  ...
  assert_link("MiniPickNormal", "NormalFloat")
  assert_true(highlight("MiniPickNormal").bg == nil, "MiniPick is not fully transparent")
  assert_true((highlight("MiniPickNormal").blend or 0) == 0, "MiniPick foreground cells were faded")
  assert_link("MiniPickPromptCaret", "MiniPickPrompt")
  assert_link("MiniPickPromptPrefix", "MiniPickPrompt")
  for _, name in ipairs({ "MiniPickPrompt", "MiniPickPromptCaret", "MiniPickPromptPrefix" }) do
    assert_true(highlight(name).bg == nil, name .. " is not fully transparent")
  ...
  assert_true(highlight("MiniPickNormal").bg == float_background, "MiniPick lost its float background")
  assert_true(highlight("MiniPickNormal").blend == 37, "MiniPick did not inherit float blend")
  for _, name in ipairs({ "MiniPickPrompt", "MiniPickPromptCaret", "MiniPickPromptPrefix" }) do
