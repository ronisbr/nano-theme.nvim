...
--- Inspired by Jinx from Arcane — near-black background with a barely perceptible
--- violet tint, hot pink salient (her hair), Hextech neon-blue strong, and electric
--- teal-cyan popout.
...
--- Inspired by the "positive image" of an amber phosphor CRT monitor —
--- warm parchment background with deep amber ink.
---@return table # Color table for the amber light variant.
local function amber_light()
  local base6   = "#7A5000"
  local red     = "#A83000"
  local green   = "#4A7000"
  local yellow  = "#907800"
...
--- Inspired by the classic amber phosphor CRT monitor — very dark background
--- with warm golden-amber glowing text.
---@return table # Color table for the amber dark variant.
local function amber_dark()
  local base6   = "#9A7010"
  local red     = "#C83020"
  local green   = "#A0A010"
  local yellow  = "#E8C040"
